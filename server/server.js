...
app.get("/api/hotels", async (req, res) => {
  try {
    const { destination, checkInDate, checkOutDate, adults, currency, key } =
      req.query;
    ...
    const apiUrl = `https://serpapi.com/search?engine=google_hotels&q=hotels+in+${encodeURIComponent(
      destination
    )}&check_in_date=${checkInDate}&check_out_date=${checkOutDate}&api_key=${key}`;
