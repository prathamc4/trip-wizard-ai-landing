        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Making travel planning simple, smart, and personalized with the power of AI.
            </p>
            <div className="flex space-x-4">
              {['facebook', 'twitter', 'instagram', 'linkedin'].map(social => (
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center hover:bg-gray-700">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.name}>
                  <a 
                    href={link.href} 
                    className="text-gray-400 hover:text-travel-green transition-colors"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              {[
                'Help Center', 'Blog', 'Travel Guides', 'FAQs', 'Privacy Policy', 'Terms of Service'
              ].map(item => (
                <li key={item}>
                  <a 
                    href="#" 
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 text-travel-blue mr-3 mt-0.5" />
                <span className="text-gray-400">
                  123 Travel Street, Suite 100<br />San Francisco, CA 94107
                </span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-travel-blue mr-3" />
                <a href="tel:+15551234567" className="text-gray-400 hover:text-white">
                  +1 (555) 123-4567
                </a>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-travel-blue mr-3" />
                <a href="mailto:info@aitravelplanner.com" className="text-gray-400 hover:text-white">
